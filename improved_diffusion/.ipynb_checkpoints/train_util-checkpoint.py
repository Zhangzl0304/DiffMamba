...
# from .sampling_util import CMR_sampling_major_vote_func
...
class TrainLoop:
    ...
    def run_loop(self, max_iter=119400*5, start_log_iter=1194*100,start_print_iter=30000000, vis_batch_size=8, n_rounds=3):
        pbar = tqdm()
        while (
            self.step < max_iter
        ):
        ...
        #   for samples in self.data:
            im_avg_und, im_avg_gnd, mask = samples
