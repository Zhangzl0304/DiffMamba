...
logdir = "/home/zhenlin/DiffMamba/log/Multi_sens_tune/v5_cmask4/"
...
wandb.init(project="DiffMamba ST Multi", name = "v5 cmask4 sens_tune")
wandb.config = {"epochs": 300*1194, "batch_size": 12}

max_iter=119400*3
start_log_iter=1194*50
start_test_iter=1194*50
lr = 2e-5
lr_anneal_steps=119400*3
