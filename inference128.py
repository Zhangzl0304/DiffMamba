...
result_dir = "/home/zhenlin/DiffMamba/Result/v3_fullsize_cmask4_ST1/429840_128/"
model_path = "/home/zhenlin/DiffMamba/log/v3_fullsize_cmask4_ST1/model_429840.pt"
pic_save_path = '/home/zhenlin/DiffMamba/Pic_Result/v3_fullsize_cmask4_ST1/429840_128/'
################################################
...
from data_loader_Cmask import TestDataFullSize128CmaskNorm
import argparse
import logging
import os
import random
...
Testdata = TestDataFullSize128CmaskNorm(4, 'sax', norm = '01')
torch.set_num_threads(8)

CMR_sampling_major_vote_func_with_dc(diffusion, model, result_dir, Testdata, logger, True, pic_save_path=pic_save_path)
