...
############################
# model_path = "/home/zhenlin/DiffMamba/log/v4_fullsize_cmask4_patch96_S&T1_norm/model_71640.pt"
os.environ["CUDA_VISIBLE_DEVICES"] = "2"
logdir = "/home/zhenlin/DiffMamba/log/SSMvideo_2/"
...
wandb.init(project="SSMvideo", name = "v1 patch96 re")
...
def main():
    ...
    logger.log("model details: adding tem layer according to SSM meet video diffusion")
